...
**Public SDK for Chronos plugin development**  
Version: 1.0.0 LTS

This package contains only contracts – interfaces, abstract base classes, records, enums, and utilities – with **no runtime logic**.  
It is the only dependency you need to build plugins for Chronos (adapters, strategies, indicators, risk managers, etc.).
...
- [Plugin Developer Guide](../../docs/Chronos%20Plugin%20Developer%20Guide%20(v1.0.0%20LTS).md) – Full tutorial for building plugins.
- [Configuration Reference](../../docs/Chronos%20Configuration%20Reference%20(v1.0.0%20LTS).md) – All configuration objects and validation rules.
- [Glossary](../../docs/Chronos%20Glossary%20(v1.0.0%20LTS).md) – Domain terms defined.
- [Chronos Principles](../../docs/Chronos%20Principles.md) – Architectural rules that govern all Chronos code.
...
2. Add this package:
   ...
   ```
3. Add the required assembly attributes (see Plugin Developer Guide §3.2).
4. Implement your plugin interface(s).
5. Build and place the DLL in the engine’s `plugins/` folder, or upload to Chronos Cloud.

## Versioning

This package follows [Semantic Versioning](https://semver.org).  
Breaking changes only occur in major releases. See the Plugin Developer Guide for compatibility rules.

## License

Proprietary. Redistribution allowed. See the license file included in the repository.
```
