// -----------------------------------------------------------------------------
// <copyright file="LoggingService.cs" company="Razor Platform">
...
internal sealed class LoggingService : ILoggingService, IAsyncDisposable
{
    ...
    public Task InitializeAsync(CancellationToken cancellationToken)
    {
        ...
        string logFileTemplate = Path.Combine(logDirectory, "Razor-{yyyy-MM-dd}.log");

        Log.Logger = new LoggerConfiguration()
            .MinimumLevel.Information()
            // Suppress verbose internal logs.
            .MinimumLevel.Override("Razor.Core.Engine.Extensions", LogEventLevel.Warning)
            .MinimumLevel.Override("Razor.Core.Engine.Communication.CloudConnector", LogEventLevel.Warning)
            ...
            .WriteTo.File(
                path: Path.Combine(logDirectory, "Razor-errors-.log"),
