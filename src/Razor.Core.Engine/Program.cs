// -----------------------------------------------------------------------------
// <copyright file="Program.cs" company="Razor Platform">
//   Copyright (c) Razor Platform. All rights reserved.
// </copyright>
// -----------------------------------------------------------------------------

namespace Razor.Core.Engine;
...
/// <summary>
/// Main entry point for the Razor Engine.
/// </summary>
...
internal sealed class Program
{
    ...
    {
        Console.WriteLine("=== Razor Engine v1.0.0 LTS ===");
    ...
    private static async Task RunAsServiceAsync(IServiceProvider serviceProvider, CancellationToken cancellationToken)
    {
        ...
        using var host2 = Host.CreateDefaultBuilder()
            ...
            {
                options.ServiceName = "Razor Engine";
            })
            .UseSystemd()
    ...
    {
        Console.WriteLine("Razor Engine v" + AppConstants.EngineVersion);
        Console.WriteLine("Usage: Razor.Core.Engine [options]");
        ...
        Console.WriteLine("  sc create RazorEngine binPath= \"C:\\Path\\Razor.Core.Engine.exe --service --auth=user,pass,key\"");
        Console.WriteLine("\nService installation (Linux):");
        Console.WriteLine("  Create /etc/systemd/system/Razor.service with:");
        Console.WriteLine("  [Service]");
        Console.WriteLine("  ExecStart=/opt/Razor/Razor.Core.Engine --service --auth=user,pass,key");
        Console.WriteLine("  WorkingDirectory=/opt/Razor");
    }
    ...
    {
        Console.WriteLine($"Razor Engine v{AppConstants.EngineVersion} LTS");
