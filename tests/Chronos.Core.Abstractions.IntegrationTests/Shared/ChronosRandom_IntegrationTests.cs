...
public class ChronosRandom_IntegrationTests
{
    [Fact]
    public void Deterministic_Across_One_Million_Calls()
    {
        var rng1 = new ChronosRandom(12345);
        var rng2 = new ChronosRandom(12345);
    ...
    {
        var rng1 = new ChronosRandom(999);
        var rng2 = new ChronosRandom(999);
